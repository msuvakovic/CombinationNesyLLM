...
from Alfworld.env_utils import run_alfworld
from Alfworld.utils import MAX_STEP_NUM
...
def setup_pipeline(args):
    if args.method == 'ours':
        ...
        path_prompt = {
            'adapt_fact': os.path.join(base_dir, 'ours_prompts', 'adapt', 'fact.txt'),
            'adapt_rule': os.path.join(base_dir, 'ours_prompts', 'adapt', 'rule.txt'),
            'goal': os.path.join(base_dir, 'ours_prompts', 'adapt', 'goal_state_ours.txt'),
        }
