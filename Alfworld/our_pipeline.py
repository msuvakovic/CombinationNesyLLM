...
from Alfworld.utils import parse_act_obs
...
class Pipeline:
    def __init__(self, args = {}):
        ...
        for k,v in args.items():
            setattr(self, k, v)
        self.total_cost = 0
        base = os.path.dirname(__file__)  # path to Alfworld/ (this file's directory)
        self.load_prompt({
            "general_fact": os.path.join(base, "ours_prompts/general/fact.txt"),
            "general_rule": os.path.join(base, "ours_prompts/general/ILP_rule.txt"),
            "general_bk":   os.path.join(base, "ours_prompts/general/ILP_bk.txt"),
            "adapt_fact":   os.path.join(base, "ours_prompts/adapt/fact.txt"),
            "adapt":        os.path.join(base, "ours_prompts/adapt/rule.txt"),
            "goal":         os.path.join(base, "ours_prompts/adapt/goal_state_ours.txt"),
            "goal_state_ours": os.path.join(base, "ours_prompts/adapt/goal_state_ours.txt"),
        })
